...
namespace mvcSchool.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //Defining property for Application DB Context to add UserRole:
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            {
                //Added BirthDate:
                //Second Change: Adding User Name
                ...
                if (result.Succeeded)
                {
                    ...
                    //Creating method to assign Role to the user
                    await UserManager.AddToRoleAsync(user.Id, model.UserRole);
                    return RedirectToAction("Index", "Home");
                }
                //If faild we get the filled list of User Roles:
                ViewBag.Roles = new SelectList(context.Roles.Where(q => !q.Name.Contains("Admin")).ToList(), "Name", "Name");
